...
// ============================================================
// Megafunction Name(s):
// 			nios2_ddr2_phy_alt_mem_phy
// ============================================================
// Generated by altmemphy 13.0 [Altera, IP Toolbench 1.3.0 Build 156]
// ************************************************************
...
module nios2_ddr2_phy (
	...
	nios2_ddr2_phy_alt_mem_phy	nios2_ddr2_phy_alt_mem_phy_inst(
	...
	defparam
		nios2_ddr2_phy_alt_mem_phy_inst.FAMILY = "Cyclone IV E",
		nios2_ddr2_phy_alt_mem_phy_inst.MEM_IF_MEMTYPE = "DDR2",
		nios2_ddr2_phy_alt_mem_phy_inst.DLL_DELAY_BUFFER_MODE = "LOW",
		nios2_ddr2_phy_alt_mem_phy_inst.DLL_DELAY_CHAIN_LENGTH = 12,
		nios2_ddr2_phy_alt_mem_phy_inst.DQS_DELAY_CTL_WIDTH = 6,
		nios2_ddr2_phy_alt_mem_phy_inst.DQS_OUT_MODE = "DELAY_CHAIN2",
		nios2_ddr2_phy_alt_mem_phy_inst.DQS_PHASE = 6000,
		nios2_ddr2_phy_alt_mem_phy_inst.DQS_PHASE_SETTING = 2,
		nios2_ddr2_phy_alt_mem_phy_inst.DWIDTH_RATIO = 2,
		nios2_ddr2_phy_alt_mem_phy_inst.MEM_IF_DWIDTH = 16,
		nios2_ddr2_phy_alt_mem_phy_inst.MEM_IF_ADDR_WIDTH = 13,
		nios2_ddr2_phy_alt_mem_phy_inst.MEM_IF_BANKADDR_WIDTH = 2,
		nios2_ddr2_phy_alt_mem_phy_inst.MEM_IF_CS_WIDTH = 1,
		nios2_ddr2_phy_alt_mem_phy_inst.MEM_IF_CS_PER_RANK = 1,
		nios2_ddr2_phy_alt_mem_phy_inst.MEM_IF_DM_WIDTH = 2,
		nios2_ddr2_phy_alt_mem_phy_inst.MEM_IF_DM_PINS_EN = 1,
		nios2_ddr2_phy_alt_mem_phy_inst.MEM_IF_DQ_PER_DQS = 8,
		nios2_ddr2_phy_alt_mem_phy_inst.MEM_IF_DQS_WIDTH = 2,
		nios2_ddr2_phy_alt_mem_phy_inst.MEM_IF_OCT_EN = 0,
		nios2_ddr2_phy_alt_mem_phy_inst.MEM_IF_CLK_PAIR_COUNT = 1,
		nios2_ddr2_phy_alt_mem_phy_inst.MEM_IF_CLK_PS = 6173,
		nios2_ddr2_phy_alt_mem_phy_inst.MEM_IF_CLK_PS_STR = "6173 ps",
		nios2_ddr2_phy_alt_mem_phy_inst.MEM_IF_MR_0 = 1074,
		nios2_ddr2_phy_alt_mem_phy_inst.MEM_IF_MR_1 = 1092,
		nios2_ddr2_phy_alt_mem_phy_inst.MEM_IF_MR_2 = 0,
		nios2_ddr2_phy_alt_mem_phy_inst.MEM_IF_MR_3 = 0,
		nios2_ddr2_phy_alt_mem_phy_inst.PLL_STEPS_PER_CYCLE = 64,
		nios2_ddr2_phy_alt_mem_phy_inst.SCAN_CLK_DIVIDE_BY = 2,
		nios2_ddr2_phy_alt_mem_phy_inst.MEM_IF_DQSN_EN = 0,
		nios2_ddr2_phy_alt_mem_phy_inst.DLL_EXPORT_IMPORT = "EXPORT",
		nios2_ddr2_phy_alt_mem_phy_inst.MEM_IF_ADDR_CMD_PHASE = 90,
		nios2_ddr2_phy_alt_mem_phy_inst.RANK_HAS_ADDR_SWAP = 0;
endmodule
...
// Retrieval info: <MEGACORE title="ALTMEMPHY"  version="13.0"  build="198"  iptb_version="1.3.0 Build 156"  format_version="120" >
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.DDRPHYMVCModel"  active_core="nios2_ddr2_phy_alt_mem_phy" >
...
// Retrieval info:      <PRIVATE name = "mem_if_clk_mhz" value="162.0"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "local_if_clk_mhz_label" value="162.0"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "pll_ref_clk_mhz" value="81.0"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "mem_if_clk_ps_label" value="(6173 ps)"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "pll_ref_clk_ps_label" value="(12346 ps)"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "mem_if_preset" value="Samsung K4T51163QB-GCCC"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "ref_clk_source" value="altpll_0"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "ctl_self_refresh_en" value="true"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "alt_top" value="nios2_ddr2_phy_alt_mem_phy_seq_wrapper"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "family" value="Cyclone IV E"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "filename" value="nios2_ddr2_phy_alt_mem_phy_seq_wrapper.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "simgen2">
// Retrieval info:      <PRIVATE name = "family" value="Cyclone IV E"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "command" value="--simgen_arbitrary_blackbox=+nios2_ddr2_phy_alt_mem_phy_seq_wrapper;+nios2_ddr2_phy_alt_mem_phy_reconfig;+nios2_ddr2_phy_alt_mem_phy_pll;+nios2_ddr2_phy_alt_mem_phy_delay --ini=simgen_tri_bus_opt=on"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "parameter" value="SIMGEN_INITIALIZATION_FILE=C:\Users\maomh\AppData\Local\Temp\alt7550_2644637721875535231.dir\0005_iptb_gen/nios2_ddr2_phy_simgen_init.txt"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// Retrieval info:      <PRIVATE name = "filename" value="nios2_ddr2_phy_syn.v"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
