...
create_driver dac2904_driver

# Associate it with some hardware known as "dac2904"
set_sw_property hw_class_name dac2904

# The version of this driver is "9.11", making it newer 
# version 9.1 dac2904 software driver.
...
# C/C++ source files
add_sw_property c_source HAL/src/dac2904.c
...
# DAC2904_INIT and DAC2904_INSTANCE macros.)
add_sw_property include_source HAL/inc/dac2904.h
add_sw_property include_source inc/dac2904_regs.h
...
#     makefile): "DAC2904_SMALL", which means: "emit
#     CPPFLAGS += DAC2904_SMALL in generated makefile
...
#  o Description text
add_sw_setting boolean_define_only public_mk_define enable_small_driver DAC2904_SMALL false "Small-footprint (polled mode) driver"

# Add per-driver configuration option for optional IOCTL functionality in
# DAC2904 driver.
# add_sw_setting boolean_define_only public_mk_define enable_ioctl DAC2904_USE_IOCTL false "Enable driver ioctl() support"
