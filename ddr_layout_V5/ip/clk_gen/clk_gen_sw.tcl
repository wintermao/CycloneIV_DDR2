...
create_driver clk_gen_driver

# Associate it with some hardware known as "clk_gen"
set_sw_property hw_class_name clk_gen
...
# C/C++ source files
add_sw_property c_source HAL/src/clk_gen.c
...
# CLK_GEN_INIT and CLK_GEN_INSTANCE macros.)
add_sw_property include_source HAL/inc/clk_gen.h
add_sw_property include_source inc/clk_gen_regs.h
...
#     makefile): "CLK_GEN_SMALL", which means: "emit
#     CPPFLAGS += CLK_GEN_SMALL in generated makefile
...
#  o Description text
add_sw_setting boolean_define_only public_mk_define enable_small_driver CLK_GEN_SMALL false "Small-footprint (polled mode) driver"

# Add per-driver configuration option for optional IOCTL functionality in
# CLK_GEN driver.
# add_sw_setting boolean_define_only public_mk_define enable_ioctl CLK_GEN_USE_IOCTL false "Enable driver ioctl() support"
